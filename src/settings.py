...
class Settings(metaclass=SettingsMeta):
    ...
    @classmethod
    @property
    def mobile_schedule_rksi(cls) -> str:
        return cls.__MOBILE_SCHEDULE_RKSI_URL

    @classmethod
    @property
    def schedule_rksi(cls) -> str:
        return cls.__SCHEDULE_RKSI_URL

    @classmethod
    @property
    def iubip_group(cls) -> str:
        return cls.__IUBIP_GROUP_URL

    @classmethod
    @property
    def rgups_url(cls) -> str:
        return cls.__RGUPS_URL
